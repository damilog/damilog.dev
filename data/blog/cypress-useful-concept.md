...
Cypress로 E2E 테스트 코드를 작성하다 보면 반복되는 코드나 가독성이 떨어지는 코드가 자주 눈에 띄곤 합니다. 특히 Cypress Studio를 이용해 자동으로 E2E 테스트 코드을 생성하는 경우 그런 코드를 자주 접하게 됩니다.
...
E2E 테스트 코드를 작성하다 보면 테스트할 케이스와 이벤트의 선후 관계를 반복적으로 정의하는 경우가 많아 이 반복적인 케이스를 추상화하여 재사용하는 방법을 학습하게 되었습니다.
위 개념들과 더불어 Cypress 공식 문서에서 제공하는 여러 커맨드들을 살펴보며 유지 보수에 용이한 테스트 코드로 개선해 보면 좋을 것 같습니다.
